...
@NamedQueries({
    ...
    @NamedQuery(name = "Menu.findByMenuCommando", query = "SELECT m FROM Menu m WHERE m.menuCommando = :menuCommando"),
...
public class Menu implements Serializable {
    ...
    @Size(max = 50)
    @Column(name = "MenuCommando")
    private String menuCommando;
    @Size(max = 50)
    ...
    public String getMenuCommando() {
        return menuCommando;
    }

    public void setMenuCommando(String menuCommando) {
        this.menuCommando = menuCommando;
    }
    ...
    public String toString() {
        return "com.softwareatumedida.modelo.Menu[ menuCodigo=" + menuCodigo + " ]";
    }
