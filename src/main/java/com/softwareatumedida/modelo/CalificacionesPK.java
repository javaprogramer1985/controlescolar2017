...
public class CalificacionesPK implements Serializable {
    ...
    public CalificacionesPK(String alumnoMatricula, int calificacionId) {
    ...
    public boolean equals(Object object) {
        ...
        if (this.calificacionId != other.calificacionId) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.softwareatumedida.modelo.CalificacionesPK[ alumnoMatricula=" + alumnoMatricula + ", calificacionId=" + calificacionId + " ]";
    }
